...
<p align="justify">Para conseguir modificar uma <strong>CNN</strong> para uma <strong>BNN</strong> em python puro foi necessário realizar algumas alterações no código disponível.</p>
